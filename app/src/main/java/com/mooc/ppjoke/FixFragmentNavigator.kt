...
class FixFragmentNavigator(private var mContext: Context, private var mManager: FragmentManager, private var mContainerId: Int) :
...
//        ft.replace(mContainerId, frag)
        ...
        val mBackStack = field.get(this) as Deque<Int>
